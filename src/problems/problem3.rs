    ...
    format!(
        ...
        <body>
            <h2>
                ...
                Luckily, we can provide you with an <a href="/problem3/locations">overview</a> of the destinations we'll need to visit<br/>
                To get the travel times, you can use our <a href="/problem3/from-to">Applied Pizza Interface</a> to get the travel times between two locations.
                Calculate <u>the minimum travel time</u> for our courrier to <u>visit every location and come back</u> here again.<br/>
